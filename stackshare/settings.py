"""
Django settings for stackshare project. Fore more info, see:
...
ADMINS = (
    ("Alexis Santos", "Alexis.Santos@icloud.com"),
)
...
WSGI_APPLICATION = 'stackshare.wsgi.application'
